...
Substantive decisions, including the scope of claims, the renaming of emergence to Protocol-Induced Cognition, the introduction of the Collaboration Gain Model, the priority of the Interactive Reasoning Benchmark, the governance structure, and the overall positioning of the standard, are the human author's. The technical drafting, prior-art review, structural editing, and prose execution involved AI contribution.
